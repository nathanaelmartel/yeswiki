        ...
        foreach ($vForms as &$vForm) {
            ...
            foreach ($vTemplate as &$vField) {
                if ('map' == $vField[0]) {
                    ...
                    if ('bf_latitude' == $vField[1] && 'bf_longitude' == $vField[2]) {
                        ...
                        $vNeedUpdate = true;
                    } elseif ('bf_geolocation' !== $vField[1]) {
        ...
        foreach ($vFormsToProcess as $vForm) {
            ...
            foreach ($vEntries as &$vEntry) {
                ...
                if ($vNeedUpdate) {
                    ...
                    unset($vEntry['body']['carte_google'], $vEntry['body']['bf_latitude'], $vEntry['body']['bf_longitude'], $vEntry['body']['geolocation']);
